...
export const constantRouterMap = [{
	...
	},
	{
		...
		children: [{
				path: 'windControlAudit',
				component: _import('businessManage/windControlAudit/index'),
				name: 'windControlAudit',
				meta: {
					title: 'windControlAudit',
					icon: 'component',
					noCache: true
				}
			},
			{
				path: 'customerManage',
				component: _import('businessManage/customerManage/index'),
				name: 'customerManage',
				meta: {
